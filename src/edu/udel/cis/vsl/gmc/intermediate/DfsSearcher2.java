package edu.udel.cis.vsl.gmc.intermediate;
 ...
 */
public class DfsSearcher2<STATE, TRANSITION, TRANSITIONSEQUENCE> {

	/**
	 * The enabler, used to determine the set of enabled transitions at any
	 * state, among other things.
	 */
	private SequentialEnablerIF<STATE, TRANSITION, TRANSITIONSEQUENCE> enabler;
	 ...
	 */
	public DfsSearcher2(SequentialEnablerIF<STATE, TRANSITION, TRANSITIONSEQUENCE> enabler,
...
//					enabler.setFullExpanded(sequence, true);
				}
